...
\keywords{脑机接口；运动想象；脑电信号；时间窗优化；强化学习；表格型 Q-Learning；轻量化设计}
\end{abstract}
...
\enkeywords{Brain-Computer Interface; Motor Imagery; EEG; Time Window Optimization; Reinforcement Learning; Tabular Q-Learning; Lightweight Design}
\end{enabstract}
