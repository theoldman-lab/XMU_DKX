...
\begin{itemize}
    \item \textbf{输入层}：状态维度（时间窗参数编码）
    \item \textbf{隐藏层 1}：64 隐藏单元 + ReLU 激活
    \item \textbf{隐藏层 2}：32 隐藏单元 + ReLU 激活
    \item \textbf{输出层}：动作空间维度（4 维，对应 4 个动作的 Q 值）
\end{itemize}
...
\subsection{仓库地址}
\begin{itemize}
    \item \textbf{GitHub 仓库}: \url{https://github.com/theoldman-lab/XMU_DKX.git}
\end{itemize}


\subsection{仓库截图}
图~\ref{fig:github_repo} 展示了该 GitHub 仓库的主页面。
