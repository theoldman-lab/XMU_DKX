...
\xmuchapter{基于表格型 Q-Learning 的时间窗优化方法}{Method}
\label{chap:method}
...
\xmusection{问题形式化}{Problem Formulation}
\label{sec:formulation}

本节将时间窗优化问题形式化为马尔可夫决策过程（Markov Decision Process, MDP），并定义优化目标。

\xmusubsection{马尔可夫决策过程建模}{Markov Decision Process Modeling}
\label{subsec:mdp}
...
\xmusubsection{优化目标}{Optimization Objectives}
...
\xmusection{表格型 Q-Learning 算法}{Tabular Q-Learning Algorithm}
\label{sec:qlearning}

\xmusubsection{算法原理}{Algorithm Principles}
...
\xmusubsection{算法设计}{Algorithm Design}
\label{subsec:design}
...
\xmusubsection{推理过程}{Inference Process}
...
\xmusection{收敛性分析}{Convergence Analysis}
\label{sec:convergence}

\xmusubsection{收敛性定理}{Convergence Theorem}
...
\xmusubsection{本研究的收敛性保证}{Convergence Guarantees of This Study}
...
\xmusection{与深度 Q 网络的理论对比}{Theoretical Comparison with DQN}
\label{sec:comparison}

\xmusubsection{DQN 方法回顾}{Review of DQN Methods}
...
\xmusubsection{理论特性对比}{Comparison of Theoretical Properties}
...
\xmusubsection{适用边界分析}{Applicability Boundary Analysis}
...
\xmusubsection{方法选择依据}{Basis for Method Selection}
